...
​下面这个片段非常的重要因为它定义了我们STM32从上电到执行我们程序中最重要的几个部分：即首先执行了：SystemInit，然后跳转道\_\_main函数，最终程序进入我们的main进行代码执行！
