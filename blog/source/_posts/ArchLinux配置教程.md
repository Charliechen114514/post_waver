---
title: "虚拟机Arch Linux With KDE6(x11)安装小记"
date: 2024-03-20
---
...
![image-20240319194216766](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319194216766.png)
...
![image-20240319122704119](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319122704119.png)
...
​![image-20240319123856904](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319123856904.png)
...
![image-20240319124014490](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124014490.png)
...
![image-20240319124141856](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124141856.png)
...
![image-20240319124204765](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124204765.png)
...
![image-20240319124300888](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124300888.png)

​分完长上面那样，然后光标选中write后提示你输入yes表示确认，随后quit处出cfdisk

​我们使用fdisk确认我们的分区：

![image-20240319124423859](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124423859.png)
...
![image-20240319124557960](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124557960.png)
...
![image-20240319124700796](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124700796.png)
...
![image-20240319124804747](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319124804747.png)
...
![image-20240319125104714](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125104714.png)

![image-20240319125121138](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125121138.png)
...
![image-20240319125232674](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125232674.png)
...
![image-20240319125705793](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125705793.png)
...
![image-20240319125729743](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125729743.png)
...
![image-20240319125917955](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319125917955.png)
...
![image-20240319130026863](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319130026863.png)
...
![image-20240319130143841](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319130143841.png)
...
![image-20240319130516016](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319130516016.png)
...
![image-20240319192613536](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192613536.png)
...
![image-20240319192703265](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192703265.png)

![image-20240319192725987](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192725987.png)
...
![image-20240319192803637](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192803637.png)
...
![image-20240319192825175](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192825175.png)
...
![image-20240319192953511](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319192953511.png)
...
![image-20240319193142194](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319193142194.png)
...
![image-20240319193241453](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319193241453.png)
...
![image-20240319193401104](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319193401104.png)
...
​![image-20240319195728856](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319195728856.png)

​顺嘴一提：如果你只是一个普通用户，不需要强验证ringKey的话，考虑将SigLevel设置为Never（虚拟机不怕（乐））

![image-20240319195626822](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319195626822.png)
...
![image-20240320121517131](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320121517131.png)
...
![image-20240320121944803](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320121944803.png)

> 在这里启动

![image-20240320122008635](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320122008635.png)

​选择打开系统代理之后，就可以直接google了（在刚刚下载好的浏览器里直接正常操作）：

![image-20240320122142376](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320122142376.png)
...
![image-20240320122501233](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320122501233.png)

​在设置那里选择配置Konsole,切换到配置方案页面。咱们新建一个配置方案：

![image-20240320122615093](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320122615093.png)

​在外观上，设置字体（选择你自己下的Nerd Font即可）：

![image-20240320123941804](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320123941804.png)

​现在新建一个标签页：很好，就长这样

![image-20240319220024290](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319220024290.png)
...
![image-20240320123810913](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320123810913.png)

​然后开一个终端就行，如果没问题，就会是这样的

![image-20240320123910399](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320123910399.png)
...
![image-20240319221426461](/img/articles/2024-03-20-ArchLinux配置教程/image-20240319221426461.png)
...
![image-20240320124330709](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320124330709.png)

​现在打开代理，确保自己的alias已经配置好并被终端读取

![image-20240320124414719](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320124414719.png)
...
​![image-20240320130206684](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320130206684.png)
...
![image-20240320130635235](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320130635235.png)
...
![image-20240320130750175](/img/articles/2024-03-20-ArchLinux配置教程/image-20240320130750175.png)
